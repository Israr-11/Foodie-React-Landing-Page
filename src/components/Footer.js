    ...
    <div>
      ...
      <footer class="bg-white text-center text-black mt-5 ">
        <div class="container p-4">
          ...
          <section class="mb-4">
            <p>
              Here at Foodie.com we make sure to use healthy and fresh vegetables and cereals in making
              best meals. Meaty dishes are prepared using meat of healthy animals bought from trusted firms.
        ...
        <div class="text-center p-3" style={{ backgroundColor: "#FF9F0D" }}>
          © 2022 Copyright
          <a class="text-white" style={{ textDecoration: "none" }} href="https://Foodie.com/"> Foodie.com</a>
        </div>
      </footer>
    </div>
  )
