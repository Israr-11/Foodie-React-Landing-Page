    ...
    <>
      <div className="container">
        <div style={{ textAlign: "center", marginTop: 50 }} >
          <p class="text-center" style={{ color: "#FF9F0D" }}>Menu</p>
          <p class="h2">Explore our new Menu</p>
          {/* <h1>Explore our new Menu</h1> */}
          <p class="text-center">We give the meals that you require everyday <br /> &nbsp; So, that you can enjoy it with family</p>
        </div>
          ...
          <div className='col-12 col-md-6 col-lg-4'>
            <div className='card'>
              ...
              <div className='card-body' style={{ textAlign: "center" }}>
                ...
                <button type="button" class="btn btn-warning btn-sm" onClick={first}>Buy Now</button>
              </div>
            </div>
          </div>
          ...
          <div className='col-12 col-md-6 col-lg-4'>
            <div className='card'>
              ...
              <div className='card-body' style={{ textAlign: "center" }}>
                ...
                <button type="button" class="btn btn-warning btn-sm" onClick={second}>Buy Now</button>
              </div>
            </div>
          </div>
          ...
          <div className='col-12 col-md-6 col-lg-4'>
            <div className='card'>
              ...
              <div className='card-body' style={{ textAlign: "center" }}>
                ...
                <button type="button" class="btn btn-warning btn-sm" onClick={third}>Buy Now</button>
              </div>
            </div>
          </div>
          ...
          <div className='col-12 col-md-6 col-lg-4'>
            <div className='card mt-4' >
              ...
              <div className='card-body' style={{ textAlign: "center" }}>
                ...
                <button type="button" class="btn btn-warning btn-sm" onClick={fourth}>Buy Now</button>
              </div>
            </div>
          </div>
          ...
          <div className='col-12 col-md-6 col-lg-4'>
            <div className='card mt-4' >
              ...
              <div className='card-body' style={{ textAlign: "center" }}>
                ...
                <button type="button" class="btn btn-warning btn-sm" onClick={fifth}>Buy Now</button>
              </div>
            </div>
          </div>
          ...
          <div className='col-12 col-md-6 col-lg-4'>
            <div className='card mt-4' >
              ...
              <div className='card-body' style={{ textAlign: "center" }}>
                ...
                <button type="button" class="btn btn-warning btn-sm" onClick={sixth}>Buy Now</button>
              </div>
            </div>
          </div>
        </div>
