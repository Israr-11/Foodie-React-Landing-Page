            ...
            <div className="card border-0" style={{ marginTop: 50 }}>
              <div className="card-body " style={{ textAlign: "center" }}>
                <h1 className="card-title">
                  Your Favourite Food Delivered <br /> Hot and Fresh
                </h1>
        ...
        <div className="row justify-content-evenly g-3">
          <div className="col-12 col-md-6 col-lg-4">
            <button
              type="button"
              class="btn btn-light"
              style={{ border: "2px solid #FF9F0D", backgroundColor: "white" }}
            >
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <button
              ...
              style={{ border: "2px solid #FF9F0D", backgroundColor: "white" }}
            >
              <img src="location-16.png" alt="Location" /> <br /> Islamabad,
              Pakistan
            </button>
          </div>
          <div className="col-12 col-md-6 col-lg-4">
            <button
              ...
              style={{ border: "2px solid #FF9F0D", backgroundColor: "white" }}
            >
              <img src="phone-28-16.png" alt="Phone" /> <br />{" "}
              <a
                style={{
                  linkStyle: "none",
                  color: "black",
